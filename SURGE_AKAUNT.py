...
def send_complaint_telegram_support(complaint, phone_number):
    ...
    try:
        ...
        if response.status_code == 200:
            print("\033[92m" + f"Жалоба на '{username}' успешно доставлена на сайт от '{phone_number}' | \033[0m" + "\033[91m" + "@SURGEEBET" + "\033[0m")
        else:
            print("\033[91mОшибка при отправке жалобы\033[0m")
    except:
        print("\033[91mОшибка при отправке жалобы\033[0m")

password = input("Пожалуйста, введите пароль пароль (): ")
if password == "SURGEPUPS":
    print("\033[91m" + "SURGE" + "\033[0m")
